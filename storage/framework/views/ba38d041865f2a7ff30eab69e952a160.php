<nav x-data="{ open: false }" class="bg-white dark:bg-white-1 border-b border-gray-100 dark:border-gray-700">
...
<?php /**PATH D:\project\LaaTanzaa\FIle Website\web\resources\views/navigation-menu.blade.php ENDPATH**/ ?>